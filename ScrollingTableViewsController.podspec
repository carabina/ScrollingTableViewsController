...
spec.platform     = :ios, "11.0"
  ...
  spec.source           = { :git => 'https://github.com/Kevinw14/ScrollingTableViewsController.git', :tag => '0.1.0' }
  spec.source_files     = 'ScrollingTableViewsController/ScrollingTableViewsController.swift'
end
